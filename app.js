...
const patient_warning = {
    high_glucose_level_over: "The patient's blood flucose level is currently over the safety threshold, please check again.",
    weight_over: "The patient's weight is currently over the safety threshold, please check again.",
    insulin_over: "The patient's insulin doses is currently over the safety threshold, please check again.",
    exercise_over: "The patient's exercise steps is currently over the safety threshold, please check again.",
    high_glucose_level_missing: "The patient has not filled in their blood glucose level, please check again.",
    weight_missing: "The patient has not filled in their weight, please check again.",
    insulin_missing: "The patient has not filled in their insulin, please check again.",
    exercise_missing: "The patient has not filled in their exercise steps, please check again.",
}
